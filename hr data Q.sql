...
# Q2. what is the race/ ethricity breakdown of employees in the company
select race, count(*) as count from hr
where age >= 18 and termdate = '0000-00-00'
group by race
order by count(*) desc;

# Q3. what is the age distribution of emplyees in the company
...
# Q5. What is the average length of emplyment for employees who have been terminated
select round(avg(datediff(termdate, hire_date))/365, 0) as avg_length_employment from hr
where termdate <= curdate() and termdate <> '0000-00-00' and age >= 18;

# Q6.  How does the gender distribution vary across departhnets and job titles
select department, gender, count(*) as count from hr
where age >= 18 and termdate = '0000-00-00'
group by department, gender
order by department;

# Q7. What is the distribution of job title across the company
...
# Q10. How has the company's employee count changed over time based on hire dand term dates
select
year,
hires,
terminations,
